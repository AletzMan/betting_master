...
export interface Teams { home: number, away: number }
...
export interface IOptions {
    ...
    average: "averageGoals" | "redCards" | "averageAssists" | "averageSuccessPasses" | "averageSaves"
}

export interface IErrorMatches { home: boolean[], away: boolean[] }