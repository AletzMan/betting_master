...
export const topicSchema = z.object({
	topic: z.string({ required_error: "El tema es requerido." }).min(5, { message: "El tema debe tener al menos 5 caracteres." }),
	...
	link: z.string().url({ message: "El enlace debe ser una URL válida." }).optional(),
});